                  ...
                  <div className="mb-3 flex items-start justify-between gap-3 sm:mb-4">
                    ...
                    {isAuthenticated && username === "amritanshu99" && (
                      <button
                        ...
                        className="rounded-full border border-zinc-200 bg-white/90 p-1.5 text-red-500 transition hover:border-red-200 hover:bg-red-50 hover:text-red-700 dark:border-zinc-600 dark:bg-zinc-950 dark:text-red-300 dark:hover:border-red-400/40 dark:hover:bg-red-500/15 dark:hover:text-red-200"
                        onClick={(e) => {
                          e.stopPropagation();
