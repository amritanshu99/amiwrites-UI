          ...
          <div className="grid grid-cols-1 gap-3.5 sm:gap-4 md:grid-cols-2 2xl:grid-cols-3">
            {filteredBlogs.map((blog) => {
              ...
              return (
                <article
                  key={blog._id}
                  className="group flex min-h-[244px] w-full cursor-pointer flex-col rounded-[1.35rem] border border-white/80 bg-white/90 p-4 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.18)] backdrop-blur-sm transition hover:-translate-y-1 hover:border-sky-100 hover:shadow-[0_24px_50px_-34px_rgba(15,23,42,0.24)] dark:border-zinc-800 dark:bg-[#050505] dark:hover:border-sky-400/45 dark:shadow-[0_20px_45px_-34px_rgba(0,0,0,0.92)] dark:ring-1 dark:ring-white/5 sm:min-h-[270px] sm:rounded-[1.5rem] sm:p-5"
                  onClick={() => {
                    trackClick(blog._id);
                ...
                >
                  <div className="mb-3 flex items-start justify-between gap-3 sm:mb-4">
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="rounded-full bg-slate-100 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-600 dark:bg-zinc-950 dark:text-zinc-100">
                        Blog
                      </p>
                      {isTrending && (
                        <span
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    <h3 className="mt-2 line-clamp-2 text-[15px] font-semibold leading-5 text-zinc-950 transition group-hover:text-sky-700 dark:text-zinc-50 dark:group-hover:text-sky-200 sm:mt-2.5 sm:text-[1.05rem] sm:leading-6">
                      {blog.title}
                    </h3>
