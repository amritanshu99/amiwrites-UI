...
const BlogList = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#f8fafc_0%,_#edf3f8_35%,_#f8fafc_100%)] px-3 py-3 dark:bg-[linear-gradient(180deg,_#09090b_0%,_#111827_42%,_#09090b_100%)] sm:px-5 sm:py-4 lg:px-8 lg:py-6">
      <PushNotificationButton />

      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 sm:gap-4">
        <section className="overflow-hidden rounded-[1.25rem] border border-white/70 bg-white/85 px-4 py-4 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.24)] backdrop-blur-sm dark:border-white/10 dark:bg-zinc-900/82 dark:shadow-[0_24px_70px_-42px_rgba(0,0,0,0.65)] sm:rounded-[1.5rem] sm:px-5 sm:py-4 lg:px-6 lg:py-5">
          ...
          <div className="relative">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-2 max-w-2xl text-base font-semibold tracking-tight text-zinc-950 dark:text-white sm:text-[1.35rem] lg:text-[1.65rem]">
        ...
        <section className="rounded-[1.2rem] border border-white/70 bg-white/85 p-3 shadow-[0_16px_40px_-32px_rgba(15,23,42,0.2)] backdrop-blur-sm dark:border-white/10 dark:bg-zinc-900/82 dark:shadow-[0_16px_40px_-32px_rgba(0,0,0,0.6)] sm:rounded-[1.35rem] sm:p-3.5">
          <div className="flex flex-col gap-2.5 lg:flex-row lg:items-end lg:justify-between">
            <div className="w-full lg:max-w-xl">
              <input
                ...
                className="w-full rounded-xl border border-zinc-300/90 bg-white/95 px-4 py-2.5 text-sm text-zinc-900 outline-none transition focus:border-sky-600 focus:ring-4 focus:ring-sky-100 dark:border-zinc-700 dark:bg-zinc-950/95 dark:text-white dark:focus:border-sky-400 dark:focus:ring-sky-500/10"
              />
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    <h3 className="mt-2 line-clamp-2 text-[15px] font-semibold leading-5 text-zinc-950 transition group-hover:text-sky-700 dark:text-zinc-100 dark:group-hover:text-sky-300 sm:mt-2.5 sm:text-[1.05rem] sm:leading-6">
                      {blog.title}
                    </h3>
