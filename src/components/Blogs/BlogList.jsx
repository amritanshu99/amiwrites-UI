...
const BlogList = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#f8fafc_0%,_#edf3f8_35%,_#f8fafc_100%)] px-3 py-3 dark:bg-black sm:px-5 sm:py-4 lg:px-8 lg:py-6">
      <PushNotificationButton />

      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 sm:gap-4">
        <section className="overflow-hidden rounded-[1.25rem] border border-white/70 bg-white/85 px-4 py-4 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.24)] backdrop-blur-sm dark:border-zinc-800 dark:bg-black dark:shadow-[0_24px_70px_-42px_rgba(0,0,0,0.9)] sm:rounded-[1.5rem] sm:px-5 sm:py-4 lg:px-6 lg:py-5">
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-sky-300/60 to-transparent dark:via-sky-400/40" />
        ...
        <section className="rounded-[1.2rem] border border-white/70 bg-white/85 p-3 shadow-[0_16px_40px_-32px_rgba(15,23,42,0.2)] backdrop-blur-sm dark:border-zinc-800 dark:bg-black dark:shadow-[0_16px_40px_-32px_rgba(0,0,0,0.88)] sm:rounded-[1.35rem] sm:p-3.5">
          <div className="flex flex-col gap-2.5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex w-full flex-col gap-2.5 sm:flex-row lg:w-auto lg:items-end">
              ...
              <div className="flex items-end">
                <div className="w-full rounded-xl border border-zinc-200/80 bg-zinc-50/90 px-3 py-2.5 text-xs leading-5 text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300 sm:px-3.5 sm:text-sm">
          ...
          <div className="grid grid-cols-1 gap-3.5 sm:gap-4 md:grid-cols-2 2xl:grid-cols-3">
            {filteredBlogs.map((blog) => {
              ...
              return (
                <article
                  key={blog._id}
                  className="group flex min-h-[244px] w-full cursor-pointer flex-col rounded-[1.35rem] border border-white/80 bg-white/90 p-4 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.18)] backdrop-blur-sm transition hover:-translate-y-1 hover:border-sky-100 hover:shadow-[0_24px_50px_-34px_rgba(15,23,42,0.24)] dark:border-zinc-800 dark:bg-black dark:hover:border-sky-400/45 dark:shadow-[0_20px_45px_-34px_rgba(0,0,0,0.92)] sm:min-h-[270px] sm:rounded-[1.5rem] sm:p-5"
                  onClick={() => {
                    trackClick(blog._id);
                ...
                >
                  <div className="mb-3 flex items-start justify-between gap-3 sm:mb-4">
                    ...
                    {isAuthenticated && username === "amritanshu99" && (
                      <button
                        ...
                        className="rounded-full border border-zinc-200 bg-white/90 p-1.5 text-red-500 transition hover:border-red-200 hover:bg-red-50 hover:text-red-700 dark:border-zinc-800 dark:bg-zinc-950 dark:text-red-300 dark:hover:border-red-400/40 dark:hover:bg-red-500/15 dark:hover:text-red-200"
                        onClick={(e) => {
                          e.stopPropagation();
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    <h3 className="mt-2 line-clamp-2 text-[15px] font-semibold leading-5 text-zinc-950 transition group-hover:text-sky-700 dark:text-zinc-100 dark:group-hover:text-sky-200 sm:mt-2.5 sm:text-[1.05rem] sm:leading-6">
                      {blog.title}
                    </h3>
