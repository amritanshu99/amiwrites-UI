      ...
      <div ref={pulseRef} className="pointer-events-auto flex justify-end">
        {!isExpanded ? (
          ...
          <section
            ...
            className="relative isolate w-full max-h-[calc(100svh-5.75rem-env(safe-area-inset-top))] overflow-x-hidden overflow-y-auto overscroll-contain rounded-[1.65rem] border border-white/80 bg-white/[0.92] text-slate-950 shadow-[0_32px_92px_-40px_rgba(15,23,42,0.72),0_1px_0_rgba(255,255,255,0.96)_inset] ring-1 ring-sky-100/90 backdrop-blur-2xl dark:border-white/[0.11] dark:bg-zinc-950/[0.92] dark:text-white dark:shadow-[0_34px_98px_-42px_rgba(0,0,0,1),0_0_0_1px_rgba(255,255,255,0.04)_inset] dark:ring-cyan-100/10 sm:max-h-[min(42rem,calc(100svh-7rem))] sm:rounded-[1.8rem]"
          >
            ...
            <header className="sticky top-0 z-20 flex items-start gap-3 border-b border-slate-200/70 bg-white/[0.88] p-4 backdrop-blur-2xl dark:border-white/[0.08] dark:bg-zinc-950/[0.88] sm:gap-4 sm:p-5">
