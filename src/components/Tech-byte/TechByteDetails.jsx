...
const TechNewsSkeleton = ({ featured = false }) => (
  <div
    className={`animate-pulse overflow-hidden rounded-[1.5rem] border border-zinc-200/80 bg-white/95 shadow-[0_18px_40px_-32px_rgba(15,23,42,0.14)] dark:border-slate-800/90 dark:bg-slate-950/90 dark:shadow-[0_18px_40px_-32px_rgba(0,0,0,0.55)] sm:rounded-[1.75rem] ${
      featured ? "lg:col-span-2" : ""
    }`}
  >
    <div className={`${featured ? "h-56 sm:h-72" : "h-44 sm:h-52"} w-full bg-zinc-200 dark:bg-slate-800`} />
...
function TechNewsCards() {
  ...
  return (
    <div className="min-h-screen w-full bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.96),_rgba(232,240,249,0.95)_22%,_rgba(241,245,249,1)_52%,_rgba(248,250,252,1)_100%)] px-3 py-3 dark:bg-[radial-gradient(circle_at_top,_rgba(30,41,59,0.95),_rgba(15,23,42,1)_28%,_rgba(9,9,11,1)_68%,_rgba(3,7,18,1)_100%)] sm:px-5 sm:py-4 lg:px-8 lg:py-6">
      <section className="mx-auto max-w-7xl">
        <div className="overflow-hidden rounded-[1.3rem] border border-white/80 bg-white/84 px-4 py-4 shadow-[0_30px_90px_-50px_rgba(15,23,42,0.25)] backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-950/78 dark:shadow-[0_30px_90px_-50px_rgba(2,6,23,0.9)] sm:rounded-[1.6rem] sm:px-5 sm:py-4 lg:px-6 lg:py-5">
          ...
          <div className="relative border-b border-zinc-200/80 pb-4 dark:border-slate-800 sm:pb-5">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-2 max-w-2xl text-base font-semibold tracking-tight text-zinc-950 dark:text-slate-50 sm:text-[1.4rem] lg:text-[1.65rem]">
            ...
            {loading ? (
              ...
              <>
                {featuredArticle && (
                  ...
                  >
                    <div className="grid h-full grid-cols-1 lg:grid-cols-[1.25fr_1fr]">
                      <div className="relative min-h-[200px] overflow-hidden bg-zinc-100 dark:bg-slate-900 sm:min-h-[280px] lg:min-h-full">
                        <img
                        ...
                        <span className="absolute left-4 top-4 rounded-full bg-white/92 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-zinc-900 dark:bg-slate-950/90 dark:text-slate-100 sm:left-5 sm:top-5">
                          Lead Story
                        </span>
                      </div>
                      ...
                      <div className="flex flex-col p-4 sm:p-5 lg:p-6">
                        ...
                        <h2 className="mt-3 text-xl font-semibold leading-tight text-zinc-950 transition group-hover:text-sky-700 dark:text-slate-50 dark:group-hover:text-sky-300 sm:mt-4 sm:text-2xl">
                          {featuredArticle.title}
                        </h2>

                        <p className="mt-3 line-clamp-4 text-sm leading-5 text-zinc-600 dark:text-slate-300 sm:mt-4 sm:leading-6 sm:text-[15px]">
                        ...
                        <div className="mt-auto pt-4 sm:pt-5">
                          <button
                            ...
                            className="inline-flex min-h-[42px] min-w-[148px] items-center justify-center rounded-full bg-zinc-950 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-sky-400 dark:text-slate-950 dark:hover:bg-sky-300 sm:min-h-[44px] sm:min-w-[160px] sm:px-5"
                          >
                            Read Full Story
                          </button>
                        </div>
                ...
                {secondaryArticles.map((article) => (
                  ...
                  >
                    <div className="relative h-40 w-full overflow-hidden bg-zinc-100 dark:bg-slate-900 sm:h-44 lg:h-48">
                      <img
                    ...
                    <div className="flex h-full flex-col p-4 sm:p-5">
                      <div className="mb-2.5 flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-zinc-500 dark:text-slate-400 sm:mb-3">
                      ...
                      <h2 className="line-clamp-2 text-[15px] font-semibold leading-5 text-zinc-950 transition-colors duration-300 group-hover:text-sky-700 dark:text-slate-50 dark:group-hover:text-sky-300 sm:text-[1.05rem] sm:leading-6">
                        {article.title}
                      </h2>

                      <p className="mt-2.5 flex-grow line-clamp-3 text-sm leading-5 text-zinc-600 dark:text-slate-300 sm:mt-3 sm:line-clamp-4 sm:leading-6">
                        {article.description || "No description available."}
                      </p>

                      <div className="mt-3 text-xs text-zinc-500 dark:text-slate-400 sm:mt-4">
                        <span>
                          Source:{" "}
                          <a
                      ...
                      <button
                        ...
                        className="mt-4 inline-flex min-h-[42px] w-full items-center justify-center rounded-full bg-zinc-950 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-sky-400 dark:text-slate-950 dark:hover:bg-sky-300 sm:mt-5 sm:min-h-[44px]"
                      >
                        Read More
                      </button>
                    </div>
